...
module.exports = class MemeCommand extends commando.Command {
    constructor(client) {
        super(client, {
            ...
            group: 'misc',
            memberName: 'meme',
            description: 'Sends a meme from Dank Memes',
        })
    }
    async run (msg) {
           ...
           function postRandomMeme(msg) {
            return loadMemes().then((posts) => {
             ...
             const embed = new Discord.MessageEmbed({
              ...
              image: { url },
              //description: { url },
              footer: { text: 'Subreddit : r/dankmemes,' + " Yoinkbot collects your usernames and tag to improve our services, to find out whats being collected contact the bot owner with the command '?owner'" },
             });
             // Send the embed
